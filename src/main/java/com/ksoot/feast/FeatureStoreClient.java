...
public class FeatureStoreClient {
  ...
  //  public static FeatureStoreDsl.FeatureViewsBuilder entities(final String name, final String...
  // more) {
  //    return null;
  //  }

  public FeatureStoreDsl.FeatureViewsBuilder entities(
      final Entity entity, final Entity... entities) {
    return new FeatureStoreDsl.Executor(this.feastRegistryClient, entity, entities);
  }

  public FeatureStoreDsl.FeatureViewsBuilder entities(final Collection<Entity> entities) {
    return new FeatureStoreDsl.Executor(this.feastRegistryClient, entities);
  }
